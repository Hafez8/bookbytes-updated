...
class _ChangePasswordPageState extends State<ChangePasswordPage> {
  ...
  Future<void> _updatePassword() async {
    ...
    String verifyPasswordUrl = 'https://infnitvoid.com/bookbytes/php/verify_pass.php';
    String updatePasswordUrl = 'https://infnitvoid.com/bookbytes/php/update_password.php';
